# Decompile by NAEEM KHAN (Tools By Cobra-Linux ABIR KHAN)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://raw.githubusercontent.com/naeemn2m/OldCrack/main/Premium.txt"])
	exit(" [*] FACEBOOK : https://www.facebook.com/mdnaeem.n2m ")
...
def notice():
	...
	runtxt("\033[0;92m BYPASS ADMIN TELEGRAM >> https://www.facebook.com/mdnaeem.n2m")
	runtxt("\033[0;95m    <===================☠️  \033[0;97mEXIT\033[0;95m ☠️===================> ")
	subprocess.check_output(["am", "start", "https://www.facebook.com/mdnaeem.n2m"])
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      :  \n")
		print(" [ Sosial Medi  ] \n")
		print(" [*] Facebook  : https://www.facebook.com/mdnaeem.n2m ")
		print(" [*] Instagram : https://instagram.com/naeemn2m ")
		print(" [*] YouTube   : https://youtube.com/ ")
		exit(" [*] GitHub    : https://github.com/naeemn2m")
	else:
		Main()
